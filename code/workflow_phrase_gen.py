...
from transformers import AutoTokenizer, BartForConditionalGeneration, T5ForConditionalGeneration, MvpForConditionalGeneration, PegasusForConditionalGeneration
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        inputs = tokenizer(row.content.lower(), padding='max_length', max_length=cfg.max_len_content, truncation=True, return_tensors='pt')
...
class Config:
    def __init__(self, **kws):
        ...
        self.model_path = './models/t5-large'
